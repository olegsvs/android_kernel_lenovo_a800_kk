...
//	kal_uint16 lenc_g[36];      //OV5647 no lens calibration data
//	kal_uint16 lenc_b[25];
//	kal_uint16 lenc_r[25];
};

#define OV5647MIPI_USE_AWB_OTP
//#define OV5647_USE_LENC_OTP   //ov5647 no lens calibration data  //copy form OV5650 LENC OTP

#define RG_TYPICAL 0x52  //golden sample R/G ratio
#define BG_TYPICAL 0x5a  //golden sample B/G ratio
