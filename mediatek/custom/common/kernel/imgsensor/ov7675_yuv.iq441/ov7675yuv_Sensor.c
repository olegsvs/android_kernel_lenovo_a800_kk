...
{                                          
          ...
          OV7675_write_cmos_sensor(0x14,0x48);
          ...
          OV7675_write_cmos_sensor(0x62,0x10);
          OV7675_write_cmos_sensor(0x63,0x10);
          OV7675_write_cmos_sensor(0x64,0x20);
          OV7675_write_cmos_sensor(0x65,0x08);
          OV7675_write_cmos_sensor(0x66,0x05);
          OV7675_write_cmos_sensor(0x94,0x1e);
          OV7675_write_cmos_sensor(0x95,0x23);  
          ...
          OV7675_write_cmos_sensor(0x44,0xf0);
          OV7675_write_cmos_sensor(0x45,0x34);
          OV7675_write_cmos_sensor(0x46,0xa8);
          OV7675_write_cmos_sensor(0x47,0x27);//26
          OV7675_write_cmos_sensor(0x48,0x32);
          OV7675_write_cmos_sensor(0x59,0x88);
          OV7675_write_cmos_sensor(0x5a,0xa8);
          OV7675_write_cmos_sensor(0x5b,0xca);
          OV7675_write_cmos_sensor(0x5c,0x56);
          OV7675_write_cmos_sensor(0x5d,0x80);
          OV7675_write_cmos_sensor(0x5e,0x0c);
          ...
          OV7675_write_cmos_sensor(0x01,0x80);
          OV7675_write_cmos_sensor(0x02,0x80);  
          OV7675_write_cmos_sensor(0x13,0xe7);
  
          OV7675_write_cmos_sensor(0x4f,0x75);
          OV7675_write_cmos_sensor(0x50,0x70);//72 74
          OV7675_write_cmos_sensor(0x51,0x02);
          OV7675_write_cmos_sensor(0x52,0x15);//14
          OV7675_write_cmos_sensor(0x53,0x64);
          OV7675_write_cmos_sensor(0x54,0x77);
          ...
          OV7675_write_cmos_sensor(0x9d,0xa5);
          OV7675_write_cmos_sensor(0x9e,0xa5);
          OV7675_write_cmos_sensor(0xa5,0x04);
          OV7675_write_cmos_sensor(0xab,0x04);
