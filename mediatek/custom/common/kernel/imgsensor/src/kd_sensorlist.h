...
UINT32 OV5647tMIPISensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
#endif
#if defined(OV5647_TRULY_RAW)
    {OV5647TRULY_SENSOR_ID, SENSOR_DRVNAME_OV5647TRULY_RAW, OV5647TRULYSensorInit}, 
#endif
#if defined(OV5647_tMIPI_RAW)
    {OV5647tMIPI_SENSOR_ID, SENSOR_DRVNAME_OV5647tMIPI_RAW, OV5647tMIPISensorInit}, 
#endif
